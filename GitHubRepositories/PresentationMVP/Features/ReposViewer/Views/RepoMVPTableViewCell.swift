...
final class RepoMVPTableViewCell: UITableViewCell {

    static let reuseIdentifier = "RepoMVPTableViewCell"
    ...
    private let starsLabel = RepoMVPTableViewCell.makeStatLabel()
    private let forksLabel = RepoMVPTableViewCell.makeStatLabel()
    private let languageLabel = RepoMVPTableViewCell.makeStatLabel()
    ...
    func configure(with model: RepoMVPRowState) {
...
extension RepoMVPTableViewCell {
